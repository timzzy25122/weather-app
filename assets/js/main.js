...
async function submit() {
  let markup = "";
  weatherDetails.innerHTML = `<img src="https://mir-s3-cdn-cf.behance.net/project_modules/disp/04de2e31234507.564a1d23645bf.gif" alt="loading..." style="width: 200px; height:200px">`;
...
async function fetchWeather(query) {
  try {
    const res = await fetch(
      `http://api.weatherapi.com/v1/current.json?key=4655e2887f654943921110810242008&q=${query}&aqi=no`
    );
